...
void processReceivedCommand( )
{
	...
	else if( stringCompare( receivedAttribute, "mod" ) == 0 )
	{
	    ...
	    modIndex = atoi( commandExpander( receivedValue, 0 ) );

	    setRemoteMod( modIndex );
	}
...
{
    // the data in this is demo only right now
    // need to add structure and variables to handle the module data

    char* modIndexString = itoa( buffer1, modIndex, 10 );
    //    commandBuilder1( "Set", "mod", modIndexString, "a", name, version );
    //    commandBuilder1( "Set", "mod", modIndexString, "b", data1 );
    //    commandBuilder1( "Set", "mod", modIndexString, "c", data2 );

    switch( modIndex )
    {
    case 0:
	break;
	commandBuilder4( "Set", "mod", modIndexString, "a", "MyMod0", "ver 0.00" );
	commandBuilder3( "Set", "mod", modIndexString, "b", "mydata01" );
	commandBuilder3( "Set", "mod", modIndexString, "c", "mydata02" );

    case 1:
	commandBuilder2( "Set", "mod", modIndexString, "NONE" );
	break;

    case 2:
	commandBuilder4( "Set", "mod", modIndexString, "a", "MyMod2", "ver 0.20" );
	commandBuilder3( "Set", "mod", modIndexString, "b", "mydata21" );
	commandBuilder3( "Set", "mod", modIndexString, "c", "mydata22" );
	break;
    ...
    case 4:
	commandBuilder4( "Set", "mod", modIndexString, "a", "MyMod0", "ver 0.00" );
	commandBuilder3( "Set", "mod", modIndexString, "b", "mydata1" );
	commandBuilder3( "Set", "mod", modIndexString, "c", "mydata2" );
	break;
