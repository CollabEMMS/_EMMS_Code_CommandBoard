...
${OBJECTDIR}/PowerMain.o: PowerMain.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  PowerMain.c  -o ${OBJECTDIR}/PowerMain.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/PowerMain.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -std=gnu99 -O0 -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/PIC24F/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/generic/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/include" -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/MasterComm.o: MasterComm.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  MasterComm.c  -o ${OBJECTDIR}/MasterComm.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/MasterComm.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -std=gnu99 -O0 -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/PIC24F/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/generic/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/include" -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/LEDControl.o: LEDControl.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  LEDControl.c  -o ${OBJECTDIR}/LEDControl.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/LEDControl.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -std=gnu99 -O0 -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/PIC24F/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/generic/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/include" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/LEDControl.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/ResetReport.o: ResetReport.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ResetReport.o.d 
	@${RM} ${OBJECTDIR}/ResetReport.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ResetReport.c  -o ${OBJECTDIR}/ResetReport.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/ResetReport.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -std=gnu99 -O0 -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/PIC24F/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/generic/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/include" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/ResetReport.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/_ConfigPragma.o: _ConfigPragma.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/_ConfigPragma.o.d 
	@${RM} ${OBJECTDIR}/_ConfigPragma.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  _ConfigPragma.c  -o ${OBJECTDIR}/_ConfigPragma.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ConfigPragma.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -std=gnu99 -O0 -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/PIC24F/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/support/generic/h" -I"C:/PROGRA~2/Microchip/xc16/v1.40/include" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ConfigPragma.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
