...
void initUART1( void )
{
    ...
    IPC2bits.U1RXIP = 1; // set RX interrupt priority (1-7, default 4)
...
//
//	// how to handle this
//	// create separate buffers for each UART
//	//    send and receive
//	//    need to be global to access in interrupt
//	// process them separately
//
//	// actually, can we poll for data received on the uart
//	// maybe just set a flag to read the uart if this goes off
//	// timing may be an issue if there is blocking code anywhere in this program
//
//	// need to process send info
